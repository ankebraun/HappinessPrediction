...
# predict_happiness documentation build
...
from predict_happiness import __version__ as release

# -- Project information -----------------------------------------------------

project = "predict_happiness"
author = "Kedro"
...
htmlhelp_basename = "predict_happinessdoc"
...
latex_documents = [
    (
        master_doc,
        "predict_happiness.tex",
        "predict_happiness Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "predict_happiness",
        "Project predict_happiness codebase.",
        "Data-Science",
    )
]
